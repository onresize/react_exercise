...
import { Layout, Menu, Card, Switch, Button, Popconfirm } from 'antd';
    ...
    <>
      <Layout>
        ...
        >
          ...
          <div style={{ position: 'absolute', bottom: '0', zIndex: 999, paddingLeft: '35px', width: '100%', height: '30px', lineHeight: '30px', boxSizing: 'border-box', color: 'var(--surface2)', backgroundColor: 'var(--surface1)', }}>
            <Popconfirm
              title="是否确认退出登录？"
              open={open}
              onConfirm={handleOk}
            ...
            >
              <Button size="small" onClick={loginOut} className="mr-2">
                退出登录
              </Button>
            </Popconfirm>
            <Switch
