...
export default () => {
  ...
  return (
    <>
      ...
      <img style={{ position: 'absolute', zIndex: 100, top: '50%', left: '50%', transform: 'translate(-50%, -50%)', zoom: '0.4', cursor: 'pointer', userSelect: 'none', '-webkit-user-drag': 'none', display: show }} onClick={() => playVideo()} src="https://dm30webimages.lynkco.com.cn/LynkCoPortal/Content/images/icon_play@2x.png" alt="" />
    </>
  )
}