        ...
        render={({ state, fullpageApi }) => {
          return (
            <ReactFullpage.Wrapper>
              ...
              <div className="section">
                <img src="https://www.apple.com.cn/v/iphone-13/h/images/key-features/features-modal/ip68_expanded__ebui4q5cys02_large.jpg" alt="原" style={{ height: '100%', width: '100vw', boxSizing: 'border-box' }} />
              </div>
              <div className="section">
